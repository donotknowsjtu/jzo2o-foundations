...
public class RegionServiceImpl extends ServiceImpl<RegionMapper, Region> implements IRegionService {
    ...
    public void active(Long id) {
        ...
        //todo
        int onSaleCounts = serveService.queryServeCountByRegionIdAndSaleStatus(id, FoundationStatusEnum.ENABLE.getStatus());
        if(onSaleCounts == 0){
            throw new ForbiddenOperationException("区域下没有上架的服务，无法启用");
        }
        //更新启用状态
